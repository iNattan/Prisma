...
// Configuração do Firebase (obtenha estas informações do Console do Firebase)
const firebaseConfig = {
    credential: admin.credential.cert(firebaseConfig_1.serviceAccount),
    storageBucket: 'escola-b28b0.appspot.com',
};
admin.initializeApp(firebaseConfig);
// Função para fazer o upload do arquivo para o Firebase Storage
...
// Exemplo de uso
const localFilePath = './aaa.txt';
const destinationPathInStorage = 'uploads/file.txt';
